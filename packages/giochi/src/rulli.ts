...
const CANTO = pezzi("canto", [
  ["Sussurrando", "whispered delivery", 0.34],
  ["Urlando", "shouted delivery", 0.36],
  ["Parlando", "spoken word delivery", 0.24],
...
const STRUMENTI = pezzi("strumento", [
  ...
  ["Chitarra acustica", "acoustic guitar", 0.72],
  ["Mandolino", "mandolin", 0.14],
  ["Fisarmonica", "accordion", 0.18],
  ["Theremin", "theremin", 0.06],
  ["Arpa", "harp", 0.12],
  ["Sassofono", "saxophone", 0.34],
  ["Banjo", "banjo", 0.16],
  ["Marimba", "marimba", 0.1],
  ["Tamburi a mano", "hand drums, percussion led", 0.28],
]);
...
const TECNICA = pezzi("tecnica", [
  ...
  ["Acquerello", "watercolor", 0.48],
  ["Disegno a matita", "pencil sketch", 0.52],
  ["Inchiostro", "ink drawing, cross hatching", 0.36],
  ["Collage", "paper collage", 0.2],
  ["Tre dimensioni", "3d render", 0.55],
  ["Pixel", "pixel art", 0.3],
  ["Stampa serigrafica", "screen print, limited inks", 0.16],
  ["Vetrata", "stained glass", 0.1],
  ["Mosaico", "mosaic tiles", 0.09],
  ["Ricamo", "embroidered on fabric", 0.06],
  ["Affresco", "fresco on a wall", 0.08],
]);

const INQUADRATURA = pezzi("inquadratura", [
  ["Primo piano", "close up", 0.8],
  ["Piano americano", "medium shot", 0.7],
  ["Campo lungo", "wide shot", 0.72],
