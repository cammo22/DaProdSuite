...
- **Casa** — la tua sala giochi (conto, livello col premio, partite aperte,
  premi della Banca) e cos'è venuto fuori mentre non guardavi. Chi decide ci
  trova anche lo stato del computer e la sala dall'alto;
